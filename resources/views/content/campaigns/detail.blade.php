              ...
              <div class="col">
                <div class="p-3 rounded" style="border: 2px solid #696cff; background-color: #e7e7ff;">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control bg-white" id="link-tracking" placeholder=""
                      aria-label="Link Tracking" aria-describedby="button-addon1" value="" readonly>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="input-group" style="min-width: 200px;">
                          ...
                          <button class="btn btn-primary" style="--bs-btn-padding-x: 0.75rem;" type="button"
      ...
      <div class="card">
        <div class="card-body">
          <div class="text-sm-center">
            <img src="{{ $campaign->image }}" height="48" style="max-width: 100%; max-height: fit-content;" />
          </div>
          <div class="row mt-4">
