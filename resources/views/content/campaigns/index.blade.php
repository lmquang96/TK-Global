          ...
          <form action="{{ route('campaigns') }}" method="GET">
            <div class="row">
              <div class="col-sm-6 col-md-3 mt-2 mt-md-0">
                ...
                <input type="text" class="form-control" placeholder="Shopee" id="autoComplete" name="keyword"
              ...
              <div class="col-sm-6 col-md-3 mt-4 mt-sm-auto">
        ...
        <div class="card">
          <div class="card-body">
            <div class="text-center" style="height: 48px;">
              <img src="{{ $campaign->image }}" style="max-width: 100%; max-height: 48px;" />
            </div>
            <h5 class="card-title mt-2 text-truncate" data-bs-toggle="tooltip" data-bs-offset="0,4"
              data-bs-placement="bottom" data-bs-html="true" data-bs-original-title="<span>{{ $campaign->name }}</span>">
              {{ $campaign->name }}</h5>
            <div class="d-flex">
