...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\xampp\htdocs\vite\public\storage' => 'string',
            ...
            'variables.productPagePro' => 'string',
...
'app.aliases.Vite','app.site_logo','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.E:\\xampp\\htdocs\\vite\\public\\storage','logging.default','logging.deprecations.channel',
...
'session.partitioned','variables.creatorName','variables.creatorUrl','variables.templateName','variables.templateSuffix',
'variables.templateVersion','variables.templateFree','variables.templateDescription','variables.templateKeyword','variables.licenseUrl',
'variables.livePreview','variables.productPage','variables.productPagePro','variables.support','variables.moreThemes',
'variables.documentation','variables.repository','variables.gitRepo','variables.gitRepoAccess','variables.githubFreeUrl',
'variables.facebookUrl','variables.twitterUrl','variables.githubUrl','variables.dribbbleUrl','variables.instagramUrl',
...
'authenticate','register','store-user','logout','forgot-password',
'verification.notice','verification.verify','verification.send','dashboard','get-data-chart',
'get-click-chart','campaigns','campaigns-list','campaigns-detail','report-performance',
'report-order','payment','submission','profile','profile-update-personal-info',
'profile-update-payment-info','profile-update-avatar','change-password','update-password','terms-of-service',
'privacy-policy','links-store-history','links-history',);
        registerArgumentsSet('views', 
'_partials.macros','components.date-input','components.date-range-input','components.empty-data','components.paginate',
'components.statistics','components.toast','content.authentications.auth-forgot-password-basic','content.authentications.auth-login-basic','content.authentications.auth-register-basic',
'content.authentications.forgot-password','content.authentications.login','content.authentications.re-verify-email','content.authentications.register','content.authentications.verify-email',
'content.campaigns.detail','content.campaigns.index','content.dashboard.dashboards-analytics','content.guides.privacyPolicy','content.guides.termsOfService',
'content.links.histories','content.payment.index','content.profile.changePass','content.profile.index','content.report.order',
'content.report.performance','layouts.blankLayout','layouts.commonMaster','layouts.contentNavbarLayout','layouts.sections.footer.footer',
...
'layouts.sections.styles','mail.verification','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
